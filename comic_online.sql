...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 23, 2023 lúc 03:35 PM
...
CREATE TABLE `chapter` (
  ...
  `status` varchar(30) DEFAULT NULL CHECK (`status` in ('Pending','OK')),
...
CREATE TRIGGER `up_af_chapter` AFTER UPDATE ON `chapter` FOR EACH ROW BEGIN
    ...
    IF _status = 'OK' THEN
        SELECT COUNT(*) INTO _sochap FROM chapter chap WHERE chap.id_comic = _id_comic and chap.status='OK';
...
CREATE TABLE `comic` (
  ...
  `coverphoto` mediumtext DEFAULT NULL,
...
(48, 1, 89, '2023-12-23 16:54:19', '2023-12-23 16:54:19'),
(49, 1, 90, '2023-12-23 17:34:36', '2023-12-23 17:34:36'),
(50, 1, 91, '2023-12-23 17:37:03', '2023-12-23 17:37:03'),
(51, 1, 90, '2023-12-23 17:37:29', '2023-12-23 17:37:29'),
(52, 1, 89, '2023-12-23 17:37:33', '2023-12-23 17:37:33'),
(53, 1, 90, '2023-12-23 17:37:36', '2023-12-23 17:37:36'),
(54, 1, 91, '2023-12-23 17:37:39', '2023-12-23 17:37:39'),
(55, 1, 96, '2023-12-23 18:38:17', '2023-12-23 18:38:17'),
(56, 1, 99, '2023-12-23 18:57:47', '2023-12-23 18:57:47');
